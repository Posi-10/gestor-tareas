...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-06-2021 a las 15:54:04
...
CREATE TABLE `tareas` (
  ...
  `nombre_tarea` varchar(255) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `paterno` varchar(255) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `materno` varchar(255) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `sexo` varchar(255) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `nacimiento` datetime DEFAULT NULL,
  `email` varchar(255) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `pas` varchar(45) COLLATE utf8mb4_spanish2_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
